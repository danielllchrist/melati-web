    ...
    <section>
        <div class="asset-item">
            <div class="image-container">
                <img src="{{ asset($manageAsset[0]->assetPath) }}" alt="Product Image" id="productImage{{$manageAsset[0]->assetID}}">
            </div>
            <div class="button-container">
                @csrf
                <button class="edit" onclick="document.getElementById('fileInput{{$manageAsset[0]->assetID}}').click()">Sunting</button>
                <button class="delete" data-id="{{ $manageAsset[0]->assetID }}" onclick="deleteImage('{{ $manageAsset[0]->assetID }}')">Hapus</button>
        ...
        <div class="asset-item">
            ...
            <div class="button-container">
                @csrf
                <button class="edit" onclick="document.getElementById('fileInput{{$manageAsset[1]->assetID}}').click()">Sunting</button>
                <button class="delete" data-id="{{ $manageAsset[1]->assetID }}" onclick="deleteImage('{{ $manageAsset[1]->assetID }}')">Hapus</button>
        ...
        <div class="asset-item">
            ...
            <div class="button-container">
                @csrf
                <button class="edit" onclick="document.getElementById('fileInput{{$manageAsset[2]->assetID}}').click()">Sunting</button>
                <button class="delete" data-id="{{ $manageAsset[2]->assetID }}" onclick="deleteImage('{{ $manageAsset[2]->assetID }}')">Hapus</button>
                <input type="file" id="fileInput{{$manageAsset[2]->assetID}}" style="display:none;" onchange="uploadImage(event, '{{$manageAsset[2]->assetID}}')" required accept="image/png,image/jpg,image/jpeg">
            </div>
        </div>
    </section>
