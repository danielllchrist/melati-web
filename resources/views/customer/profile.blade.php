    ...
    <div class="withsidebar">
        ...
        <div class="main-content">
            <div class="pf-inner-container">
                <div id="profil" class="pf-profile section">
                    <div class="pf-profile-info">
                        <h3 class="pf-title">Profil</h3>
                        <form action="{{ route('CustomerUpdateProfile') }}" class="pf-profileform " method = "POST">
                            @csrf
                            <div class="pf-formdetail">
                                <div class="pf-name">Nama</div>
                                <input class="pf-textfield" type="text" id="name" name="name"
