...
@include('components.customer.headercustomer')
            ...
            <div class="d-flex justify-content-between mt-3 mb-3">
                <div class="card-custom">
                    ...
                    <div class="card-custom-text">
                        <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"  onclick="showDataModal()">
    ...
    <script>
        var data = [
            {"id":1,"harga":120000,"wishlist":true}, 
            {"id":2,"harga":150000,"wishlist":false},
            {"id":3,"harga":110000,"wishlist":true}
        ];
        ...
        function showDataModal(){
            ...
            for(let i=0; i<randNumber; i++){
                if(data[i].wishlist){
                    content += "<div class=\"catalog-item\"><a href=\"detail.html\"><div class=\"card-custom\"><img src=\"assets/kambojaKutubaru.png\" class=\"card-custom-top\" alt=\"Catalog\"><div class=\"card-custom-body\"><p>Kamboja Kutubaru</p><h3>" + rupiah(data[i].harga) + "</h3></div></div></a><i class=\"fa fa-heart fa-2x heart-color\" id=\"wishlist-heart-" + data[i].id + "\" onclick=\"wishlist(event, " + data[i].id + ")\"></i></div>";
                }else{
